...
//			sc.nextLine();
	...
	public void initUpdate() {
		...
		if (bookSetupModel.searchBook(updateBook)) {
			while (true) {
			...
			alertBook("Book Not Found");
		}
	}

	public void alertBook(String msg) {// u
		System.out.println(msg);
	}

	public void successMessage(String string) {// u
		System.out.println(string);
	}

	public void initDelete() {// u
		System.out.println("Enter the DeleteBook_Name");
		String deleteBook = sc.nextLine();
		if (bookSetupModel.searchBook(deleteBook)) {
...
//			startManageBook();
	...
	public void initView() {// u
		bookSetupModel.viewAllBooks();
	}
	...
	public void showAssignBook() {
		bookSetupModel.showAssignBookToUser();
	}
}
